...
- `fcb5f55d` `test(cli): lock runtime and font edge-case contracts`
...
1. Google Fonts の family / weight / style を declarative に扱う専用 surface を追加するか判断する
2. explicit remote font の cache / offline workflow を product surface として追加するか判断する
...
- font support policy は一段固定済み。次は source contract を増やすかどうかの判断になる
